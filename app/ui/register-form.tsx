                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            ...
                            placeholder="••••••••"
                            required
                            className={`w-full rounded-lg border border-gray-300 bg-white px-3 ${inputPadding} pr-10 ${textSize} text-gray-900 placeholder:text-gray-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition`}
                        />
                        <button
                            type="button"
